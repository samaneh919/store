    ...
    <body>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <table width="650" align="center">
                ...
                <tr>
                    <td><b>نام محصول</b></td>
                    <td><input type="text" name="product_title" size="70" ></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="product_keyword" size="70" ></td>
                </tr>
        ...
        if (isset($_POST['submit'])) {
            ...
            $insert_product = "INSERT INTO products (product_title ,product_cat , product_brand , product_price , product_desc , product_image , product_keyword)
			VALUES (N'$product_title' , $product_cat , $product_brand , $product_price , N'$product_desc' , N'$address_images' , N'$product_keyword' )";
