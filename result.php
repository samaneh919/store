...
<?php
		...
		{	
			...
			$get_pro="select * from products where product_keyword like N'%$search_qurey%' OR product_title like N'%$search_qurey%'";
			...
			while($row_pro=mysqli_fetch_array($run_pro))
			{
				...
				<div class='product_box'>
					...
					<img width='200' height='150' src='Admin_area/<?php echo $pro_image;?>' alt='image' />
					<div class='price'>قیمت:<span><?php echo $pro_price;?> تومان</span></div>                           
					<div class='buynow'><a href='index.php?add_cart=<?php echo $pro_id; ?>'>هم اکنون می خرید</a></div>
					<a href='details.php?product_id=<?php echo $pro_id; ?>'>جزئیات</a>
				</div>
				<?php
			} 
		}				
